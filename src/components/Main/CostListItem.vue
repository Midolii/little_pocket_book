  ...
  >
    ...
    <div class="cost_info">
      <div class="first_line">
        <span
          >{{ item.record_date_year }}-{{ item.record_date_month }}-{{
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
          ...
          <div class="px-1 py-3 sm:px-6" v-if="isEdit == true">
            <el-row :gutter="10">
              <el-col :span="12">
                <el-date-picker
                  v-model="clickItem.data.record_date_full"
                  type="date"
                  placeholder="选择日期"
              ...
              <el-col :span="12">
                <el-time-picker
                  v-model="clickItem.data.record_hour"
                  placeholder="选择时间"
                  style="width: 100%"
                />
              </el-col>
            ...
            <dl>
              ...
              >
                ...
                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  ...
                  <el-select
                    v-model="clickItem.data.record_type"
                    placeholder="请选择类型"
                    v-if="isEdit == true"
                  >
                    <el-option
                      v-for="item in is_income_record_type[item.is_income]
                        .value"
                      :key="item"
                      :label="item.label"
                      :value="item.value"
              ...
              >
                ...
                >
                  <el-input
                    v-if="isEdit == true"
                    v-model="clickItem.data.record_content"
                    type="textarea"
                    :rows="3"
                  />
                </dd>
                      ...
                      <div class="w-0 flex-1 flex items-center">
                        <span class="ml-2 flex-1 w-0 truncate">
                          ...
                          <a
                            ...
                            @click="submitChange(clickItem.data)"
                            v-if="isEdit == true"
                          >
                            Submit
                          </a>
...
import { items, totalAll, getCurDate, getCurHour } from "@/store/cost_list";
